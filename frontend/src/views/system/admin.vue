<template>
  <div>
    <el-card>
      <div slot="header">
        <span>管理员管理</span>
        <el-button v-auth="'admin:add'" type="primary" size="small" style="float:right" @click="handleAdd">新增</el-button>
      </div>
      <el-table :data="list" border stripe>
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="{row}">
            <el-button v-auth="'admin:edit'" type="text" @click="handleEdit(row)">编辑</el-button>
            <el-button v-auth="'admin:delete'" type="text" style="color:#f56c6c" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
